    ...
    For Each rng In Workbooks(shipBk).Sheets("航次增效报表").Range("a2:a180") '分表航次增效报表找本船
        i = rng.Row
            ...
            If rng.Text = shipNam Then
                ...
                For e = i To rend
                    rMaxe = e
                    Debug.Print Workbooks(shipBk).Sheets("航次增效报表").Cells(e, 5)
...
ii:
                For ii = i To rend
                    rMaxii = ii
                    Debug.Print "row:" & ii, Workbooks(shipBk).Sheets("航次增效报表").Cells(ii, 9)
...
m:
                For m = i To rend
                    rMaxm = m
                    Debug.Print "row:" & m, Workbooks(shipBk).Sheets("航次增效报表").Cells(m, 13)
